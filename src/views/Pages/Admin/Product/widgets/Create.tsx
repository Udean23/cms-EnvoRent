...
export default function ProductCreate() {
    ...
    // Media
    const [images, setImages] = useState<string[]>([]); // URLs or base64
    const fileInputRef = useRef<HTMLInputElement>(null);

    // Sales Info (Variations)
    ...
    const handleImageUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (files && files.length > 0) {
            ...
            setImages([newImage]); // Only allow 1 image
        }
    };
    ...
    return (
        <div className="p-4 md:p-6 pb-24 bg-gray-50 min-h-screen">
            <Breadcrumb title="Tambah Produk" desc="Buat produk baru" />
